...
define(function() {
	...
	Session.prototype = {
		constructor: Session,
        // Don't remember but I think its the # of times a card proc'd...
        ...
        // Number of times something proc'd
        ...
        // Not sure but all of this affects the automated battles statistic screen.
        // I believe this keeps track of the spread of end values of deck configuration
        // so we can calculate on average, which scenario plays out most often.
        ...
        // Determine if this encounter is a win or a loss.
